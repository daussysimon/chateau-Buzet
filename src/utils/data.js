const data = {
  fr: {
    page1: {
      ...
      buttonWinery: 'Passer directement á la degustation',
      buttonTesting: 'Déguster',
    },
    page2: {
      buttonReplay: 'Rejouer',
      buttonOut: 'Sortir',
    },
    page3: {
      title: 'Quel context de dégustation associériez-vous à ce vin ?',
      option1: 'Célébration',
      option2: 'Rendez-vous gourmand',
      option3: "Cadre d'exeption",
      option4: 'Partie de campagne',
    },
    page4: {
